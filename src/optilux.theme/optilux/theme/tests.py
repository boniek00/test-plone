...
class TestSetup(unittest.TestCase):
    ...
    def test_css_registry_configured(self):
        ...
        self.assertTrue(
            "++theme++optilux.theme/stylesheets/main.css"
            in cssRegistry.getResourceIds()
            )
        
        self.assertTrue(
            "++theme++optilux.theme/stylesheets/iefixes.css"
            in cssRegistry.getResourceIds()
            )
...
class TestRendering(unittest.TestCase):
    ...
    def test_render_plone_page(self):
        ...
        self.assertTrue('<div id="content">' in browser.contents)
    ...
    def test_render_zmi_page(self):
        ...
        self.assertFalse('<div id="content">' in browser.contents)
